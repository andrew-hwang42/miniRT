...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/20 22:02:52 by ahwang            #+#    #+#             */
/*   Updated: 2026/06/20 22:02:52 by ahwang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
			...
			double *light_intensity, t_rgb3 *light_color)
{
	...
	*light_color = rgb3(data->scene->light->rgb.r
	...
	ray_calc_light = ray_vec(hit->hit_point, vec3_mul_scalar(light_direc, -1));
	*light_intensity = vec3_dot_vec3(vec3_mul_scalar(hit->normal_vec,
				1 + DELTA),
			vec3_mul_scalar(light_direc, -1));
